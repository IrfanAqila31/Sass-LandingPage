    ...
    <footer className="bg-slate-900 text-slate-200 py-12">
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-3 gap-8">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="text-sm text-slate-400">Streamline your workflow and collaboration.</p>
        </div>
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="text-xs text-slate-400 mt-2">© 2026 NexaFlow. All rights reserved.</p>
        </div>
